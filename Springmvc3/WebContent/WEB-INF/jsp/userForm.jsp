<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@ taglib uri="http://www.springframework.org/tags/form" prefix="form"%> <!-- to be used when in mvc only spring related tags are to written --> 
...
<td><form:radiobutton path="gender" value="F" label="F"/>
</td>
</tr>
<tr>
<td>Country:</td>
